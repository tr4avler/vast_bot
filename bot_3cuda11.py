...
MAX_ORDERS = 4 # number of orders you want to place
GPU_DPH_RATES = {
    "RTX 3060": 0.042,
    "RTX 3080 Ti": 0.056,
    "RTX 3090": 0.083,
...
logging.basicConfig(level=logging.INFO,
                    ...
                    handlers=[logging.FileHandler("script_output_c11.log"),
...
def monitor_instance_for_running_status(instance_id, machine_id, api_key, offer_dph, gpu_model, timeout=840, interval=30):
